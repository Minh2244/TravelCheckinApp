...
- **Sự kiện "Đăng nhập"**:
  ...
  4. **Thành công**: Lưu khóa truy cập (Token) vào bộ nhớ an toàn (`AsyncStorage`), đồng thời cập nhật trạng thái toàn cục.
...
**Cách hoạt động:**
  ...
  2. Hệ thống bật cửa sổ trình duyệt an toàn mở trang ủy quyền của Google.
  3. Google tự động trả về ứng dụng một đoạn mã xác thực.
  4. Ứng dụng gửi đoạn mã đó lên API `POST /api/auth/google`.
  5. Máy chủ xác nhận và cấp quyền đăng nhập. Ứng dụng lưu quyền và chuyển thẳng vào **Trang chủ**.
