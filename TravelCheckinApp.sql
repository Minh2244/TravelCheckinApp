...
CREATE TABLE `account_blacklist` (
  ...
  KEY `fk_account_blacklist_admin` (`banned_by`),
  KEY `fk_account_blacklist_report` (`source_report_id`),
  CONSTRAINT `fk_account_blacklist_admin` FOREIGN KEY (`banned_by`) REFERENCES `users` (`user_id`) ON DELETE SET NULL,
  CONSTRAINT `fk_account_blacklist_report` FOREIGN KEY (`source_report_id`) REFERENCES `reports` (`report_id`) ON DELETE SET NULL,
  CONSTRAINT `fk_account_blacklist_user` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE SET NULL
...
--
-- Table structure for table `booking_preorder_items`
--

DROP TABLE IF EXISTS `booking_preorder_items`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `booking_preorder_items` (
  `preorder_item_id` int NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `booking_preorder_items`
--

LOCK TABLES `booking_preorder_items` WRITE;
/*!40000 ALTER TABLE `booking_preorder_items` DISABLE KEYS */;
INSERT INTO `booking_preorder_items` VALUES (1,8,1,2,'Cafe Sữa',4,20000.00,80000.00,'preorder','2026-05-12 17:04:24','2026-05-12 17:04:24');
/*!40000 ALTER TABLE `booking_preorder_items` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `booking_table_reservations` VALUES (1,6,49,1,'2026-05-13 00:03:00','2026-05-13 01:03:00','no_show',NULL,'2026-05-13 16:16:42',NULL,NULL,'2026-05-12 17:03:51','2026-05-13 09:16:42'),(2,7,42,1,'2026-05-13 00:04:00','2026-05-13 01:04:00','no_show',NULL,'2026-05-13 16:16:42',NULL,NULL,'2026-05-12 17:04:06','2026-05-13 09:16:42'),(3,8,48,1,'2026-05-13 00:04:00','2026-05-13 01:04:00','no_show',NULL,'2026-05-13 16:16:42',NULL,NULL,'2026-05-12 17:04:24','2026-05-13 09:16:42');
...
INSERT INTO `booking_tickets` VALUES (1,1,3,7,'BT-1-1778604645967-41c0b2e3','void','2026-05-12 16:50:45',NULL,NULL),(2,1,3,7,'BT-1-1778604645969-7802d38f','void','2026-05-12 16:50:45',NULL,NULL),(3,2,3,7,'BT-2-1778605364558-dfc301ee','void','2026-05-12 17:02:44',NULL,NULL),(4,2,3,8,'BT-2-1778605364559-e7c364d2','void','2026-05-12 17:02:44',NULL,NULL),(5,9,3,8,'BT-9-1778607421166-cb7c1b0a','void','2026-05-12 17:37:01',NULL,NULL),(6,10,3,7,'BT-10-1778952224512-73cc84a3','used','2026-05-16 17:23:44','2026-05-16 17:32:45',4);
...
INSERT INTO `bookings` VALUES (1,8,NULL,NULL,7,3,'2026-05-12 16:50:44','2026-05-12 00:00:00','2026-05-12 23:59:59',2,200000.00,0.00,200000.00,NULL,'cancelled','web','[SYSTEM] Ticket expired: hết hạn khi đóng cửa','2026-05-12 17:00:07',NULL,'2026-05-12 16:50:44','2026-05-12 17:00:07',NULL),(2,8,NULL,NULL,7,3,'2026-05-12 17:02:43','2026-05-13 00:00:00','2026-05-13 23:59:59',2,150000.00,0.00,150000.00,NULL,'cancelled','web','[SYSTEM] Ticket expired: hết hạn khi đóng cửa','2026-05-15 17:54:34',NULL,'2026-05-12 17:02:43','2026-05-15 17:54:34',NULL),(3,8,NULL,NULL,7,3,'2026-05-12 17:03:04','2026-05-13 00:00:00','2026-05-13 23:59:59',2,150000.00,0.00,150000.00,NULL,'cancelled','web','[SYSTEM] Ticket expired: hết hạn khi đóng cửa','2026-05-15 17:54:34',NULL,'2026-05-12 17:03:04','2026-05-15 17:54:34',NULL),(4,8,NULL,NULL,7,3,'2026-05-12 17:03:06','2026-05-13 00:00:00','2026-05-13 23:59:59',2,150000.00,0.00,150000.00,NULL,'cancelled','web','[SYSTEM] Ticket expired: hết hạn khi đóng cửa','2026-05-15 17:54:34',NULL,'2026-05-12 17:03:06','2026-05-15 17:54:34',NULL),(5,8,NULL,NULL,7,3,'2026-05-12 17:03:06','2026-05-13 00:00:00','2026-05-13 23:59:59',2,150000.00,0.00,150000.00,NULL,'cancelled','web','[SYSTEM] Ticket expired: hết hạn khi đóng cửa','2026-05
8,'sathuonline0788746659@gmail.com','user',1,'::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36',NULL,'2026-05-18 09:44:14'),(47,8,'sathuonline0788746659@gmail.com','user',1,'::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36',NULL,'2026-05-18 15:22:09'),(48,8,'sathuonline0788746659@gmail.com','user',1,'::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36',NULL,'2026-05-18 15:29:40'),(49,8,'sathuonline0788746659@gmail.com','user',1,'::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36',NULL,'2026-05-18 16:21:18'),(50,4,'memory3367@gmail.com','owner',1,'::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36',NULL,'2026-05-19 07:09:46'),(51,4,'memory3367@gmail.com','owner',1,'::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36',NULL,'2026-05-19 07:09:46'),(52,4,'memory3367@gmail.com','owner',1,'::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36',NULL,'2026-05-19 07:09:52'),(53,8,'sathuonline0788746659@gmail.com','user',1,'::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36',NULL,'2026-05-19 07:10:02'),(54,8,'sathuonline0788746659@gmail.com','user',1,'::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36',NULL,'2026-05-19 07:12:26'),(55,8,'sathuonline0788746659@gmail.com','user',1,'::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36',NULL,'2026-05-19 07:15:08'),(56,8,'sathuonline0788746659@gmail.com','user',1,'::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36',NULL,'2026-05-19 07:23:54'),(57,8,'sathuonline0788746659@gmail.com','user',1,'::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36',NULL,'2026-05-19 07:25:08'),(58,8,'sathuonline0788746659@gmail.com','user',1,'::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36',NULL,'2026-05-19 15:05:21'),(59,8,'sathuonline0788746659@gmail.com','user',1,'::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36',NULL,'2026-05-19 15:05:21'),(60,8,'sathuonline0788746659@gmail.com','user',1,'::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36',NULL,'2026-05-19 15:11:41'),(61,8,'sathuonline0788746659@gmail.com','user',1,'::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36',NULL,'2026-05-19 16:45:17'),(62,4,'memory3367@gmail.com','owner',1,'::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36',NULL,'2026-05-20 07:16:07'),(63,4,'memory3367@gmail.com','owner',1,'::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36',NULL,'2026-05-20 07:16:07'),(64,8,'sathuonline0788746659@gmail.com','user',1,'::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36',NULL,'2026-05-20 07:19:22'),(65,8,'sathuonline0788746659@gmail.com','user',1,'::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36',NULL,'2026-05-20 07:28:11'),(66,8,'sathuonline0788746659@gmail.com','user',1,'::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36',NULL,'2026-05-20 07:33:10'),(67,8,'sathuonline0788746659@gmail.com','user',1,'::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36',NULL,'2026-05-20 09:04:05'),(68,30,NULL,'user',1,'::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36',NULL,'2026-05-20 09:10:44'),(69,4,'memory3367@gmail.com','owner',1,'::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36',NULL,'2026-05-20 09:11:43'),(70,8,'sathuonline0788746659@gmail.com','user',1,'::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36',NULL,'2026-05-20 13:05:45'),(71,8,'sathuonline0788746659@gmail.com','user',1,'::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36',NULL,'2026-05-20 13:05:45'),(72,8,'sathuonline0788746659@gmail.com','user',1,'::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36',NULL,'2026-05-20 13:17:17'),(73,8,'sathuonline0788746659@gmail.com','user',1,'::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36',NULL,'2026-05-20 14:51:15'),(74,8,'sathuonline0788746659@gmail.com','user',1,'::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36',NULL,'2026-05-20 15:19:11'),(75,8,'sathuonline0788746659@gmail.com','user',1,'::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36',NULL,'2026-05-20 15:48:44'),(76,8,'sathuonline0788746659@gmail.com','user',1,'::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36',NULL,'2026-05-20 17:02:46'),(77,8,'sathuonline0788746659@gmail.com','user',1,'::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36',NULL,'2026-05-20 17:19:01'),(78,8,'sathuonline0788746659@gmail.com','user',1,'::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36',NULL,'2026-05-20 17:23:41'),(79,8,'sathuonline0788746659@gmail.com','user',1,'::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36',NULL,'2026-05-20 17:32:58'),(80,8,'sathuonline0788746659@gmail.com','user',1,'::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36',NULL,'2026-05-20 17:46:00'),(81,1,'minhmap3367@gmail.com','admin',1,'::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36',NULL,'2026-05-20 17:57:44'),(82,4,'memory3367@gmail.com','owner',1,'::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36',NULL,'2026-05-20 17:58:34'),(83,8,'sathuonline0788746659@gmail.com','user',1,'::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36',NULL,'2026-05-20 18:01:22'),(84,8,'sathuonline0788746659@gmail.com','user',1,'::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36',NULL,'2026-05-20 18:04:21'),(85,8,'sathuonline0788746659@gmail.com','user',1,'::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36',NULL,'2026-05-20 18:26:35'),(86,8,'sathuonline0788746659@gmail.com','user',1,'::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36',NULL,'2026-05-20 18:34:37'),(87,8,'sathuonline0788746659@gmail.com','user',1,'::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36',NULL,'2026-05-20 18:40:52'),(88,8,'sathuonline0788746659@gmail.com','user',1,'::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36',NULL,'2026-05-20 18:43:59'),(89,8,'sathuonline0788746659@gmail.com','user',1,'::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36',NULL,'2026-05-21 02:02:35'),(90,8,'sathuonline0788746659@gmail.com','user',1,'::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36',NULL,'2026-05-21 02:02:35'),(91,8,'sathuonline0788746659@gmail.com','user',1,'::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36',NULL,'2026-05-21 05:23:44'),(92,8,'sathuonline0788746659@gmail.com','user',1,'::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36',NULL,'2026-05-21 05:29:49'),(93,8,'sathuonline0788746659@gmail.com','user',1,'::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36',NULL,'2026-05-21 07:46:08'),(94,8,'sathuonline0788746659@gmail.com','user',1,'::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36',NULL,'2026-05-21 08:02:08'),(95,8,'sathuonline0788746659@gmail.com','user',1,'::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36',NULL,'2026-05-21 08:08:09'),(96,8,'sathuonline0788746659@gmail.com','user',1,'::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36',NULL,'2026-05-21 08:30:05'),(97,8,'sathuonline0788746659@gmail.com','user',1,'::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36',NULL,'2026-05-21 14:22:02'),(98,8,'sathuonline0788746659@gmail.com','user',1,'::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36',NULL,'2026-05-21 14:22:02'),(99,8,'sathuonline0788746659@gmail.com','user',1,'::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36',NULL,'2026-05-21 15:16:33');
...
--
-- Table structure for table `owner_notification_dismissed`
--

DROP TABLE IF EXISTS `owner_notification_dismissed`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `owner_notification_dismissed` (
  `notification_id` int NOT NULL,
  `owner_user_id` int NOT NULL,
  `dismissed_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`notification_id`,`owner_user_id`),
  KEY `idx_owner_notification_dismissed_user` (`owner_user_id`),
  CONSTRAINT `fk_owner_notification_dismissed_notification` FOREIGN KEY (`notification_id`) REFERENCES `push_notifications` (`notification_id`) ON DELETE CASCADE,
  CONSTRAINT `fk_owner_notification_dismissed_user` FOREIGN KEY (`owner_user_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `owner_notification_dismissed`
--

LOCK TABLES `owner_notification_dismissed` WRITE;
/*!40000 ALTER TABLE `owner_notification_dismissed` DISABLE KEYS */;
/*!40000 ALTER TABLE `owner_notification_dismissed` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `owner_notification_reads`
--

DROP TABLE IF EXISTS `owner_notification_reads`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `owner_notification_reads` (
  ...
  CONSTRAINT `fk_owner_notification_reads_notification` FOREIGN KEY (`notification_id`) REFERENCES `push_notifications` (`notification_id`) ON DELETE CASCADE,
  CONSTRAINT `fk_owner_notification_reads_user` FOREIGN KEY (`owner_user_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `owner_notification_reads`
--

LOCK TABLES `owner_notification_reads` WRITE;
/*!40000 ALTER TABLE `owner_notification_reads` DISABLE KEYS */;
INSERT INTO `owner_notification_reads` VALUES (2,4,'2026-05-20 16:10:16'),(3,4,'2026-05-21 00:58:48'),(4,4,'2026-05-21 00:58:48');
/*!40000 ALTER TABLE `owner_notification_reads` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `push_notifications` VALUES (1,'Nhắc lịch trình','[booking:10][checkout] Bạn có lịch check-out sắp tới tại Bờ Kè Sông Hậu.','specific_user',8,NULL,'2026-05-17 14:58:12'),(2,'Có đánh giá mới','[owner:reviews] Nhựt Minh vừa đánh giá Cafe Trung Nguyên (1/5).','specific_user',4,8,'2026-05-20 07:20:10'),(3,'Có đánh giá mới','[owner:reviews] Nhựt Minh vừa đánh giá Cafe Trung Nguyên (5/5).','specific_user',4,8,'2026-05-20 14:27:30'),(4,'Có đánh giá mới','[owner:reviews] Nhựt Minh vừa đánh giá Cafe Trung Nguyên (4/5).','specific_user',4,8,'2026-05-20 17:24:59'),(5,'Có đánh giá mới','[owner:reviews] Nhựt Minh vừa đánh giá Cafe Trung Nguyên (2/5).','specific_user',4,8,'2026-05-21 16:09:45'),(6,'Có đánh giá mới','[owner:reviews] Nhựt Minh vừa đánh giá Cafe Trung Nguyên (5/5).','specific_user',4,8,'2026-05-21 17:13:13');
...
CREATE TABLE `review_replies` (
  ...
  `content` text NOT NULL,
  `images` json DEFAULT NULL,
  `role` enum('owner','user') DEFAULT 'owner',
  `created_by` int DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
INSERT INTO `review_replies` VALUES (1,1,'quán xin lỗi khách vì có trải nghiệm không tốt',NULL,'owner',4,'2026-05-20 17:59:17','2026-05-20 17:59:17'),(2,1,'ok','[\"/uploads/reviews/review-8-1779388411949-7e10bf24a246.jpg\"]','user',8,'2026-05-21 18:33:46','2026-05-21 18:33:46');
...
INSERT INTO `reviews` VALUES (1,8,1,NULL,1.0,'cafe quá tệ, phục vụ chửi khách','[\"/uploads/reviews/review-8-1779261610920-ec7dfc0acbc4.jpg\"]','active',NULL,NULL,NULL,'2026-05-20 07:20:10','2026-05-20 07:20:10'),(2,8,1,NULL,5.0,'quán phục vụ tốt',NULL,'deleted',NULL,'2026-05-20 15:58:54',8,'2026-05-20 14:27:30','2026-05-20 15:58:54'),(3,8,1,NULL,4.0,'quán rất ok',NULL,'active',NULL,NULL,NULL,'2026-05-20 17:24:59','2026-05-20 17:39:00'),(4,8,1,NULL,2.0,'quán tệ hại','[\"/uploads/reviews/review-8-1779379778155-aab72b95f3cd.jpg\"]','active',NULL,NULL,NULL,'2026-05-21 16:09:45','2026-05-21 16:09:45'),(5,8,1,NULL,5.0,NULL,NULL,'active',NULL,NULL,NULL,'2026-05-21 17:13:13','2026-05-21 17:13:13');
...
INSERT INTO `user_active_sessions` VALUES (1,'9e67b218-0b97-49a8-93ec-ce21406f10f7','2026-05-13 16:51:14','2026-05-21 00:57:44'),(4,'b1638ec9-b2f2-4ea6-b176-cc61a179f2cd','2026-05-13 16:50:29','2026-05-21 00:58:34'),(8,'ae627c15-d359-4c97-a8c3-2a140bd474c8','2026-05-13 16:50:05','2026-05-21 22:16:33'),(30,'1e2dccdf-871e-43bc-aa8c-4630c33b8a43','2026-05-20 16:10:44','2026-05-20 16:10:44');
...
--
-- Table structure for table `user_notification_dismissed`
--

DROP TABLE IF EXISTS `user_notification_dismissed`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `user_notification_dismissed` (
  `notification_id` int NOT NULL,
  `user_id` int NOT NULL,
  `dismissed_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`notification_id`,`user_id`),
  KEY `idx_user_notification_dismissed_user` (`user_id`),
  CONSTRAINT `fk_user_notification_dismissed_notification` FOREIGN KEY (`notification_id`) REFERENCES `push_notifications` (`notification_id`) ON DELETE CASCADE,
  CONSTRAINT `fk_user_notification_dismissed_user` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `user_notification_dismissed`
--

LOCK TABLES `user_notification_dismissed` WRITE;
/*!40000 ALTER TABLE `user_notification_dismissed` DISABLE KEYS */;
/*!40000 ALTER TABLE `user_notification_dismissed` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `user_notification_reads` (
  ...
  CONSTRAINT `fk_user_notification_reads_notification` FOREIGN KEY (`notification_id`) REFERENCES `push_notifications` (`notification_id`) ON DELETE CASCADE,
  CONSTRAINT `fk_user_notification_reads_user` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `user_notification_reads` WRITE;
/*!40000 ALTER TABLE `user_notification_reads` DISABLE KEYS */;
INSERT INTO `user_notification_reads` VALUES (1,8,'2026-05-17 23:10:23');
/*!40000 ALTER TABLE `user_notification_reads` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2026-05-22  1:34:33
