      ...
      >
        <Form form={form} layout="vertical">
          ...
          <Card size="small" title="Hình ảnh dịch vụ">
            ...
            <div className="flex flex-col sm:flex-row items-stretch gap-4 p-4 rounded-2xl border border-solid border-slate-200 bg-slate-50/40">
              <div className="flex-1 min-w-0">
                <Upload.Dragger
                  ...
                  className="!rounded-2xl !border-dashed hover:!border-blue-500 hover:!bg-blue-50/10 !transition !h-full"
                  onRemove={() => {
                    setImageFileList([]);
              ...
              <div className="w-32 flex-shrink-0 flex flex-col items-center justify-between border-l border-slate-100 pl-4 sm:border-l sm:pl-4">
                <div className="text-xs font-semibold text-slate-500 uppercase tracking-wider mb-2 w-full text-center">
                  Xem trước
                </div>
                {watchImageUrl ? (
                  <div className="relative w-32 h-32 rounded-2xl overflow-hidden border border-slate-200 shadow-md bg-white group hover:shadow-lg transition duration-300">
                    <img
                    ...
                    <button
                      type="button"
                      className="absolute top-1.5 right-1.5 h-6 w-6 flex items-center justify-center rounded-full bg-black/60 hover:bg-red-600 backdrop-blur-sm text-white border border-white/20 transition cursor-pointer"
                      onClick={() => {
                        setImageFileList([]);
                        form.setFieldValue("image_url", undefined);
                      }}
                  ...
                  <div className="w-32 h-32 rounded-2xl border border-dashed border-slate-200 bg-slate-100/50 flex flex-col items-center justify-center text-xs text-slate-400 gap-1.5 transition">
